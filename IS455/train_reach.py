"""
Train a GradientBoostingRegressor to predict reach for social media posts.
...
MODEL_OUT = MODELS_DIR / "social_reach_gb.pkl"
META_OUT  = MODELS_DIR / "social_reach_gb_metadata.json"
