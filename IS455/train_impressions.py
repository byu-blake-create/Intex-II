"""
Train a GradientBoostingRegressor to predict impressions for social media posts.
...
MODEL_OUT = MODELS_DIR / "social_impressions_gb.pkl"
META_OUT  = MODELS_DIR / "social_impressions_gb_metadata.json"
